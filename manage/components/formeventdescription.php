<div class="col-12">
  <form id="eventdescriptionform" class="needs-validation bts-form eventdescriptionform" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" novalidate>
    ...
    <div class="form-floating">
      ...
      <textarea class="form-control" id="eventDescription1" name="eventDescription1" rows="10">
      <?php if($isEventEdited) {echo $dataEventDescription1; } ?>
      </textarea>
    </div>
    <div class="form-floating">
      <label for="eventDescription2">Event description part 2</label>
      <textarea class="form-control" id="eventDescription2" name="eventDescription2" rows="10">
      <?php if($isEventEdited) {echo $dataEventDescription2; } ?>
      </textarea>
    </div>
    <div class="form-floating">
      <label for="eventDescription3">Event description part 3</label>
      <textarea class="form-control" id="eventDescription3" name="eventDescription3" rows="10">
      <?php if($isEventEdited) {echo $dataEventDescription3; } ?>
      </textarea>
    </div>
    <div class="col-12">

...
if(isset($_POST["safe_form_data"])){
  ...
  if($usernamelevel == "9") {
    ...
    $eventDataPlace = (isset($_POST["eventPlace"])) ? mysqli_real_escape_string($connector, $_POST["eventPlace"]) : null;
    $eventDataLanguage = (isset($_POST["eventLanguage"])) ? mysqli_real_escape_string($connector, $_POST["eventLanguage"]) : null;
    ...
    $enableMaintainSinglesParity = (isset($_POST["maintainSinglesParity"])) ? mysqli_real_escape_string($connector, $_POST["maintainSinglesParity"]) : null;
    $enableMaintainSinglesParity = (strtolower( $enableMaintainSinglesParity ) == "on") ? "Yes" : "No";

  ...
  $message_payments =  "<!-- PARAGRAPH -->
                    ...
                    <tr>
                      <td align='center' valign='top' style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
                        ...
                        font-family: sans-serif;' class='paragraph'>
                          ...
                          <p>with Variable symbol (VS/Variabilní symbol) <strong>" . $storedRegOrderId . "</strong></p>
                    ...
                    <tr>
                      <td align='center' valign='top' style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
                        ...
                        <p>Notice for receiver: <strong>\"Order ID:" . $storedRegOrderId . ", client: " . $storedRegClientName . " , contact: " . $storedRegClientEmail. "\"</strong></p>
                      </td>
                    </tr>
                    <tr>
                    <!-- separation line -->
...
$message_summary =  "<!-- PARAGRAPH -->
                      ...
                      <tr>
                        <td align='center' valign='top' style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
                          ...
                          color: #35384e;
                          font-family: sans-serif;' class='paragraph'>
                          <p>Order ID: <strong>" . $storedRegOrderId . "</strong></p>
...
$message_footer = "	<!-- LINE -->
  ...
  $replyto	=		"From: mauritius@bachata.com "  . " \n\r" . "Reply-To:" . $storedRegClientEmail . " \n\r";
  
  $headers = "Content-Type: text/html; charset=UTF-8";


  if (mail($to, $subject, $message, $headers))  {
    return "The mail to remind payment was sent.";
  } else {
    return "The mail to remind payment failed to be sent.";
  }

  ...
  if ($correctlyFilledForm){
    ...
    if ($results-> num_rows > 0 ) {
      while ($row = $results-> fetch_assoc()) {
        ...
        $storedconfirmPrivateInformation1 = $row["confirmPrivateInformation1"];
        $storedconfirmPrivateInformation2 = $row["confirmPrivateInformation2"];
        $storedconfirmPrivateInformation3 = $row["confirmPrivateInformation3"];
        $storedPrivateInformation1Description = $row["confirmPrivateInformation1Description"];
        $storedPrivateInformation2Description = $row["confirmPrivateInformation2Description"];
        $storedPrivateInformation3Description = $row["confirmPrivateInformation3Description"];
        ...
        $storedOtherTicketOptions = $row["otherTicketOptions"];
        $storedOtherDancerKind = $row["otherDancerKind"];

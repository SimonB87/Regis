...
if ((isset($_POST['clientName'])) or (isset($_POST['clientEmail']))) {
  ...
  $confirmCovidResult = ($confirmCovid == "on") ? "Yes, agreed with COVID-19 therms" : "Denied COVID-19 therms." ;
  $confirmPrivateInformationResult = ($confirmPrivateInformation == "on") ? "Yes, agreed with GDPR therms" : "Denied GDPR therms." ;

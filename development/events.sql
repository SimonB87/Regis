...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Čtv 18. srp 2022, 20:42
...
CREATE TABLE `events` (
  ...
  `eventDescription1` longtext CHARACTER SET latin2 COLLATE latin2_czech_cs DEFAULT NULL,
  `eventDescription2` longtext CHARACTER SET latin2 COLLATE latin2_czech_cs DEFAULT NULL,
  `eventDescription3` longtext CHARACTER SET latin2 COLLATE latin2_czech_cs DEFAULT NULL,
